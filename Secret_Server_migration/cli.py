#!/usr/bin/env python3
"""CLI entry point for the CyberArk → Secret Server Migration system.
...
def cmd_preflight(args):
    ...
    print("\n" + "=" * 60)
    print("  PREFLIGHT CHECKS (CyberArk → Secret Server)")
    print("=" * 60 + "\n")
...
def cmd_agents(args):
    ...
    print("\n  Available Agents (CyberArk → Secret Server):")
    print("  " + "-" * 50)
...
def main():
    parser = argparse.ArgumentParser(
        description="CyberArk → Delinea Secret Server Migration CLI",
