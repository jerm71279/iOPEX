...
class OnboardingAgent(AgentBase):
    """Automated application onboarding into Privilege Cloud.
    ...
    def _onboard_application(
        ...
        # Privilege Cloud uses ISPSS Identity for application access — CCP AppIDs
        ...
        cloud_url = self.config["privilege_cloud"].get("base_url", "")
